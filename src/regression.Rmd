...
par ser utilizado em Python. 

### Exemplos de aplicação do algoritmo

Para você colocar me prática os conceitos vistos, abaixo há um exemplo de aplicação do algoritmo.

- [Exemplo de Regressão Linear](https://www.kaggle.com/lordadriano/mc2-worcap-2020-linear-regression)
