...
```{r clustering-book, echo=FALSE, fig.align="center", fig.show = "hold", fig.cap='Antes e depois da organização da prateleira de livros em grupos baseados em gênero.'}
# refazer essa figura
...
```{r centroid-based, echo=FALSE, fig.align="center", fig.show = "hold", fig.cap='Exemplo de um agrupamento beaseado em partição. As linhas pretas demarcam as partições e as formas geométricas preenchidas os centróides. Adaptado de @google2020'}
