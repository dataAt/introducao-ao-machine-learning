...
```{r centroid-based, echo=FALSE, fig.align="center", fig.show = "hold", out.width="100%", fig.cap='Exemplo de um agrupamento baseado em partição. As linhas pretas demarcam as partições e as formas geométricas preenchidas os centróides. Adaptado de @google2020'}
