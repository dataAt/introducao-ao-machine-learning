...
* "Você é a média das pessoas com que anda" - Adaptação de ditado popular
...
```{r fig:class_dt6, echo=FALSE, fig.align='center', out.width = "90%", fig.cap='Entropia dos nós filhos - Fonte: Produção do autor'}
